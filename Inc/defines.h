...
#define LED1_Pin                    GPIO_PIN_4      // RED
#define LED2_GPIO_Port              GPIOB
#define LED2_Pin                    GPIO_PIN_3     // GREEN
#define LED3_GPIO_Port              GPIOA
#define LED3_Pin                    GPIO_PIN_15      // YELLOW
#define LED4_GPIO_Port              GPIOB
#define LED4_Pin                    GPIO_PIN_2      // BLUE1
#define LED5_GPIO_Port              GPIOB
#define LED5_Pin                    GPIO_PIN_5      // BLUE2
